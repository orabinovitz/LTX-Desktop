    ...
    >
      ...
      {visible &&
        ReactDOM.createPortal(
          <div
            className="pointer-events-none fixed z-[99999] select-none whitespace-nowrap rounded-md bg-white px-2.5 py-1.5 text-xs font-medium text-zinc-800 shadow-md"
            style={style}
          >
            {content}
          </div>,
