...
export function FirstRunSetup({ onComplete }: FirstRunSetupProps) {
    ...
    const init = async () => {
      try {
        ...
        try {
          ...
          if (resourcePath) {
            setVideoPath(
              `file://${resourcePath}/app.asar.unpacked/dist/splash/splash.mp4`,
            );
          }
        } catch {
  ...
  const startInstallation = async () => {
    ...
    try {
      ...
      setDownloadError(
        e instanceof Error ? e.message : "Failed to start model download.",
      );
    }
  };
            ...
            <div style={{ animation: "fadeIn 0.25s ease" }}>
              ...
              >
                ...
                >
                  <span>
                    Available:{" "}
                    <strong style={{ color: "#fff" }}>{availableSpace}</strong>
                  </span>
                </div>
              </div>
                ...
                <p style={{ fontSize: 11, color: "#888", marginTop: 8 }}>
                  {ltxApiKey ? (
                    <span style={{ color: "#6D28D9" }}>
                      ✓ Text encoder download will be skipped (using API
                      instead)
                    </span>
                  ) : (
                    ...
                    <div style={{ display: "flex", gap: 10 }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          cursor: "pointer",
                          background:
                            "linear-gradient(125deg, #A98BD9, #6D28D9)",
                          border: "none",
                          color: "#ffffff",
                        }}
                      >
                  ...
                  <>
                    ...
                    >
                      <span style={{ fontSize: 13, fontWeight: 500 }}>
                        {(downloadProgress?.totalProgress || 0) > 85
                          ? "Installing..."
                          : "Downloading..."}
                      </span>
                      <span
                    ...
                    {downloadProgress && downloadProgress.totalFiles > 0 && (
                      ...
                      >
                        File {downloadProgress.filesCompleted + 1} of{" "}
