...
export function PythonSetup({ onReady }: PythonSetupProps) {
  ...
  useEffect(() => {
    ...
    startSetup(); // eslint-disable-line react-hooks/set-state-in-effect -- Initial setup on mount
  }, []);
            ...
            {error ? (
              ...
              <>
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 13, color: "#A98BD9", fontWeight: 600 }}
                  >
                    {percent}%
                  </span>
                </div>
