      ...
      try {
        ...
        try {
          ...
          if (enhanceResponse.ok) {
            ...
            if (
              enhanceResult.status === "success" &&
              enhanceResult.enhanced_prompt
            ) {
              if (enhanceResult.skipped) {
                console.log(
                  `Prompt enhancement skipped (${enhanceMode}): ${enhanceResult.reason}`,
                );
              } else {
                finalPrompt = enhanceResult.enhanced_prompt;
                console.log(
                  `Prompt enhanced (${enhanceMode}):`,
          ...
          console.warn(
            "Prompt enhancement error, using original:",
            enhanceError,
          );
        }
