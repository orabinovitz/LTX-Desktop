...
export function TakeContextMenu({
  ...
  return (
    <div
      ...
      className="fixed z-[60] min-w-[190px] rounded-xl border border-zinc-700 bg-zinc-800 py-1.5 text-xs shadow-2xl"
      style={{ left: takeContextMenu.x, top: takeContextMenu.y }}
      onClick={(e) => e.stopPropagation()}
    >
      <div className="px-3 py-1 text-[10px] font-medium text-zinc-500">
