...
export const ACTION_REGISTRY: ActionDefinition[] = [
  ...
  {
    id: "transport.shuttleReverse",
    label: "Shuttle Reverse (J)",
    category: "Transport",
  },
  {
    id: "transport.shuttleStop",
    label: "Shuttle Stop (K)",
    category: "Transport",
  },
  {
    id: "transport.shuttleForward",
    label: "Shuttle Forward (L)",
    category: "Transport",
  },
  {
    id: "transport.stepBackward",
  ...
  {
    id: "transport.jumpBackward",
    label: "Jump Backward (1 sec)",
    category: "Transport",
  },
  {
    id: "transport.jumpForward",
    label: "Jump Forward (1 sec)",
    category: "Transport",
  },
  ...
  { id: "edit.overwriteEdit", label: "Overwrite Edit", category: "Editing" },
  {
    ...
    category: "Editing",
    description:
      "Load the clip under the playhead into the source monitor at the matching frame",
  },
  // Marking
  ...
  // Navigation
  {
    ...
    category: "Transport",
    description: "Jump playhead to previous cut on timeline",
  },
  {
    id: "nav.nextEdit",
    label: "Go to Next Edit Point",
    category: "Transport",
    description: "Jump playhead to next cut on timeline",
  },
  ...
  // Agent
  {
    ...
    category: "Agent",
    description: "Open AI editing prompt box",
  },
];
